...
public class ImpresorLCD {
    ...
    static final PuntosFijos puntosFijos = new PuntosFijos();
    ...
    private void adicionarSegmento(int segmento) {
        ...
        switch (segmento) {
            case 1:
                adicionarLinea(this.matrizImpr, puntosFijos.getPf1(), POSICION_Y,
                        this.size, CARACTER_VERTICAL);
                break;
            case 2:
                adicionarLinea(this.matrizImpr, puntosFijos.getPf2(), POSICION_Y,
                        this.size, CARACTER_VERTICAL);
                break;
            case 3:
                adicionarLinea(this.matrizImpr, puntosFijos.getPf5(), POSICION_Y,
                        this.size, CARACTER_VERTICAL);
                break;
            case 4:
                adicionarLinea(this.matrizImpr, puntosFijos.getPf4(), POSICION_Y,
                        this.size, CARACTER_VERTICAL);
                break;
            case 5:
                adicionarLinea(this.matrizImpr, puntosFijos.getPf1(), POSICION_X,
                        this.size, CARACTER_HORIZONTAL);
                break;
            case 6:
                adicionarLinea(this.matrizImpr, puntosFijos.getPf2(), POSICION_X,
                        this.size, CARACTER_HORIZONTAL);
                break;
            case 7:
                adicionarLinea(this.matrizImpr, puntosFijos.getPf3(), POSICION_X,
                        this.size, CARACTER_HORIZONTAL);
                break;
            default:
                break;
    ...
    private void imprimirNumero(int size, String numeroImp, int espacio) {
        ...
        for (char digito : digitos) {
            ...
            puntosFijos.getPf1()[0] = 0;
            puntosFijos.getPf1()[1] = 0 + pivotX;

            puntosFijos.getPf2()[0] = (this.filasDig / 2);
            puntosFijos.getPf2()[1] = 0 + pivotX;

            puntosFijos.getPf3()[0] = (this.filasDig - 1);
            puntosFijos.getPf3()[1] = 0 + pivotX;

            puntosFijos.getPf4()[0] = (this.columDig - 1);
            puntosFijos.getPf4()[1] = (this.filasDig / 2) + pivotX;

            puntosFijos.getPf5()[0] = 0;
            puntosFijos.getPf5()[1] = (this.columDig - 1) + pivotX;
